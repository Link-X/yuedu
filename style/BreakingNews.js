(function(jQuery){
	...
	$.fn.BreakingNews = function(settings){
			...
			return this.each(function(){
				...
				$(settings.modulid).css({'width':settings.width, 'background':settings.background, 'border-top':settings.border, 'font-size':settings.fonttextsize });
				//$(settings.modulid+' ul').css({'left':$(settings.modulid+' .bn-title').width()+60});
